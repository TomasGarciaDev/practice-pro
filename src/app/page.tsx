export default function Home() {
  return (
    <div className='relative bg-home-img bg-cover bg-center bg-fixed min-h-screen'>
      ...
      {/* Header */}
      <header className='relative w-full h-20 bg-[#146C94] flex items-center'>
        <h1 className='text-white ml-8 text-4xl'>HEADER</h1>
      </header>

      {/* Main Content */}
      <main className='relative w-full lg:max-w-7xl lg:mx-auto'>
